...
@ManagedBean
@SessionScoped
@FacesValidator("deleteDataValidator")

public class deleteDataValidator implements Validator {
	@Override
	public void validate(FacesContext context, UIComponent component, Object value) throws ValidatorException {
		System.out.println(component.getAttributes()+" "+component.getClientId());
